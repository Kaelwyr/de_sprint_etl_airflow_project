...
Проект посвящен интеграции нового источника данных в существующую систему хранения данных (DWH). В рамках этого проекта мы добавляем данные о продажах на конкурирующем сайте в нашу систему.
